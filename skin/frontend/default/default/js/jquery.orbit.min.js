...
(function(e){
    e.fn.orbit=function(a){
        ...
        var b=0,n=0,t,u,s,d=e(this).addClass("orbit"),f=d.find("span#img, a img");
        f.each(function(){
...
if(a.captions){
    ...
    if(a.bullets){
    if(a.bulletid){
        d.append('<ul class="orbit-bullets" id="orbit-bullets'+a.bulletid+'"></ul>');
        var E=e("ul#orbit-bullets"+a.bulletid);
        for(i=0;i<n;i++){
            j=e("<li>"+i+"</li>");
            e("ul#orbit-bullets"+a.bulletid).append(j);
            j.data("index",i);
            j.click(function(){
                a.timer&&q();
                m(e(this).data("index"))
